...
```json
{
  ...
  "agents": [
    { "agent_name": "assistant", "runtime": "openclaw", "model": "openrouter/auto" },
    {
      "agent_name": "reviewer",
      "runtime": "hermes",
